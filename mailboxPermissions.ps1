...
$file = "Desktop\MailboxPermissions-" + $dteshort + ".csv"
$Report | Sort-Object -Property @{Expression = {$_.MailboxType}; Ascending= $False}, Mailbox | Export-CSV $file -NoTypeInformation
Write-Host "All done." $Mbx.Count "mailboxes scanned. Report of non-standard permissions available in Desktop\MailboxPermissions.csv"